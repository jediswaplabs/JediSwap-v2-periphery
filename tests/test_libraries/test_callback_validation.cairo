...
fn test_verify_callback_reverts_from_wrong_address() {
    ...
    let nft_manager_dispatcher = IJediSwapV2NFTPositionManagerDispatcher {
        contract_address: nft_manager_address
    };
    ...
    let pool_address = nft_manager_dispatcher
        .create_and_initialize_pool(token0, token1, fee, sqrt_price_X96);
